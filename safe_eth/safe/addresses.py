...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.BERACHAIN: [
        ...
        ("0xfb1bffC9d739B8D520DaF37dF666da4C687191EA", 45838, "1.3.0+L2"),
        ("0x69f4D1788e39c87893C980c06EdF4b7f686e2938", 45842, "1.3.0"),
        ("0x29fcB43b46531BcA003ddC8FCB67FFE91900C762", 40887, "1.4.1+L2"),
        ("0x41675C099F32341bf84BFc5382aF534df5C7461a", 40883, "1.4.1"),
    ],
    ...
    EthereumNetwork.NIBIRU_MAINNET: [
    ...
    EthereumNetwork.NIBIRU_TESTNET_2: [
        ...
        ("0x69f4D1788e39c87893C980c06EdF4b7f686e2938", 674995, "1.3.0"),  # v1.3.0
    ...
    EthereumNetwork.HOODIE_TESTNET: [
    ...
    EthereumNetwork.BERACHAIN_BEPOLIA: [
        ...
        ("0xfb1bffC9d739B8D520DaF37dF666da4C687191EA", 2070069, "1.3.0+L2"),
        ("0x69f4D1788e39c87893C980c06EdF4b7f686e2938", 2070087, "1.3.0"),
    ],
    ...
    EthereumNetwork.ZKSYNC_SEPOLIA_TESTNET: [
        ...
        ("0x41675C099F32341bf84BFc5382aF534df5C7461a", 5131814, "1.4.1"),  # v1.4.1
        (
            "0x29fcB43b46531BcA003ddC8FCB67FFE91900C762",
            5114500,
            "1.4.1+L2",
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.BERACHAIN: [
        ("0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2", 0),  # v1.3.0 default singleton address
        ("0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC", 45810),  # v1.3.0
    ...
    EthereumNetwork.NIBIRU_MAINNET: [
        ...
        ("0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC", 19868328),  # v1.3.0 eip155
    ],
    EthereumNetwork.NIBIRU_TESTNET_2: [
        ("0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67", 674772),  # v1.4.1
        ("0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC", 675078),  # v1.3.0 eip155
    ],
    EthereumNetwork.VANA_MAINNET: [
    ...
    EthereumNetwork.ABSTRACT: [
        ...
        # EVM Compatible Stack
        ("0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67", 9054401),  # v1.4.1
        (
            "0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC",
            9093229,
        ),  # v1.3.0  Safe singleton address
    ...
    EthereumNetwork.ABSTRACT_SEPOLIA: [
        ...
        # EVM Compatible Stack
        ("0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67", 9176862),  # v1.4.1
        (
            "0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC",
            9176862,
        ),  # v1.3.0  Safe singleton address
