...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.INJECTIVE: [
        ("0xd9Db270c1B5E3Bd161E8c8503c55cEABeE709552", 135920796),  # v1.3.0
        ("0x3E5c63644E683549055b9Be8653de26E0B4CD36E", 135920788),  # v1.3.0+L2
        ("0x41675C099F32341bf84BFc5382aF534df5C7461a", 141295722),  # v1.4.1
        ("0x29fcB43b46531BcA003ddC8FCB67FFE91900C762", 141295731),  # v1.4.1+L2
    ],
}
