...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.IMMUTABLE_DEVNET: [
        ("0xE418eBDFBa5bf9d512fdF0dd19F700de60a49959", 1528994, "1.3.0+L2"), # temporary
        ("0x0e560eDaa22849d78B6aa7d60CBEFC7Dcf540818", 1529000, "1.3.0"), # temporary
    ...
    EthereumNetwork.IMMUTABLE_TESTNET: [
        ("0xE418eBDFBa5bf9d512fdF0dd19F700de60a49959", 1489892, "1.3.0+L2"), # temporary
        ("0x0e560eDaa22849d78B6aa7d60CBEFC7Dcf540818", 1489899, "1.3.0"), # temporary
        ("0xfb1bffC9d739B8D520DaF37dF666da4C687191EA", 3244331, "1.3.0+L2"),
        ("0x69f4D1788e39c87893C980c06EdF4b7f686e2938", 3244337, "1.3.0"),
    ],
    EthereumNetwork.IMMUTABLE_MAINNET: [
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.IMMUTABLE_DEVNET: [
        ("0xa87147759Ae110CC6397f0720971c4711B73218F", 1528956),  # v1.3.0-temp
        ("0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC", 3283004),  # v1.3.0
    ],
    EthereumNetwork.IMMUTABLE_TESTNET: [
        ("0xa87147759Ae110CC6397f0720971c4711B73218F", 1489834),  # v1.3.0-temp
